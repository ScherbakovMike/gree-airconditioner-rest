...
public class DeviceControlDto {
    ...
    @Schema(description = "Target temperature in Celsius (16-30)", example = "22", minimum = "16", maximum = "30")
    private Integer temperature;
    
    @Schema(description = "Operation mode", example = "COOL", allowableValues = {"AUTO", "COOL", "HEAT", "DRY", "FAN_ONLY"})
    private String mode;
    
    @Schema(description = "Fan speed", example = "AUTO", allowableValues = {"AUTO", "LOW", "MEDIUM", "HIGH"})
    private String fanSpeed;
    
    @Schema(description = "Horizontal swing", example = "DEFAULT", allowableValues = {"DEFAULT", "FULL", "FIXED_LEFT", "FIXED_RIGHT"})
    private String swingHorizontal;
    
    @Schema(description = "Vertical swing", example = "DEFAULT", allowableValues = {"DEFAULT", "FULL", "FIXED_TOP", "FIXED_BOTTOM"})
