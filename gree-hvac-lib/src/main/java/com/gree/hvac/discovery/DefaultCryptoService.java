...
public class DefaultCryptoService implements CryptoService {
  ...
  /**
   * GREE HVAC protocol specification constant. This is NOT a secret key but a publicly documented
   * protocol constant required by the GREE device firmware specification. Reference: GREE HVAC
    ...
    try {
      ...
      javax.crypto.spec.SecretKeySpec keySpec =
          new javax.crypto.spec.SecretKeySpec(
              GREE_PROTOCOL_KEY.getBytes(StandardCharsets.UTF_8), "AES"); // NOSONAR
